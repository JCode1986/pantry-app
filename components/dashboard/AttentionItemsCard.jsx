          ...
          {visibleItems.map((item) => {
            ...
            return (
              <Link
                key={item.id}
                href={itemHref}
                className="rounded-2xl border border-gray-100 bg-gray-50/40 px-3 py-2.5 transition hover:-translate-y-0.5 hover:border-[var(--stocksense-brand-border)] hover:bg-[var(--stocksense-brand-soft)]/50 hover:shadow-sm"
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {detail ? (
                    <span className="shrink-0 rounded-full border border-[var(--stocksense-brand-border)] bg-white px-2 py-0.5 text-[11px] font-semibold text-[var(--stocksense-brand)]">
                      {detail}
                    </span>
                  ) : null}
                </div>
