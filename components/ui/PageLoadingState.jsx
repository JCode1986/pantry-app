...
const authenticatedShellClasses =
  "flex min-h-[calc(100svh-61px-6rem)] w-full items-center justify-center px-4 py-8 sm:py-10 lg:min-h-[calc(100svh-var(--wherekeep-desktop-commandbar-height))] lg:px-6 lg:py-12";
