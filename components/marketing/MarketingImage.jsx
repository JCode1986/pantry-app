...
export const marketingImages = {
  heroApp: {
    src: '/images/marketing/hero-app-placeholder.webp',
    width: 900,
    height: 1200,
    alt: 'WhereKeep app search preview',
  },
  dashboard: {
    src: '/images/marketing/dashboard-placeholder.webp',
    width: 1200,
    height: 900,
    alt: 'WhereKeep dashboard preview',
  },
  search: {
    src: '/images/marketing/search-placeholder.webp',
    width: 1200,
    height: 900,
    alt: 'WhereKeep search preview',
  },
  addItem: {
    src: '/images/marketing/add-item-placeholder.webp',
    width: 1200,
    height: 900,
    alt: 'WhereKeep add item preview',
  },
  organizedHome: {
    src: '/images/marketing/organized-home-placeholder.webp',
    width: 1200,
    height: 900,
    alt: 'Organized home storage preview',
  },
  pantry: {
    src: '/images/marketing/pantry-storage.webp',
    width: 1200,
    height: 900,
    alt: 'Organized pantry storage preview',
  },
  garage: {
    src: '/images/marketing/garage-storage.webp',
    width: 1200,
    height: 900,
    alt: 'Organized garage bin preview',
  },
  documents: {
    src: '/images/marketing/documents-storage.webp',
    width: 1200,
    height: 900,
    alt: 'Organized documents preview',
  },
  family: {
    src: '/images/marketing/family-placeholder.webp',
    width: 1200,
    height: 900,
