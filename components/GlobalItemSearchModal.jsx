        ...
        {() => (
          <>
            <ModalHeader className="flex flex-col gap-1">
              <span className="text-stocksense-teal">Find item</span>
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            <div className="flex flex-wrap items-center gap-2">
                              <span className="font-semibold text-stocksense-teal">
                                {item.name}
                              </span>
                              {duplicateCount > 1 && (
                                <span className="rounded-full border border-[#9FE7D7] bg-[#E6FAF6] px-2 py-0.5 text-[11px] text-[#0E7488]">
                            ...
                            <div className="mt-2 grid gap-1 text-sm text-gray-600">
                              <span className="inline-flex items-center gap-2">
                                <FaMapMarkerAlt className="h-3.5 w-3.5 text-[#0E7488]" />
                                {itemPath(item)}
                              </span>
